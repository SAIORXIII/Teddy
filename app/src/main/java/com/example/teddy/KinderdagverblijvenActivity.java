...
public class KinderdagverblijvenActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kinderdagverblijven);


        setTitle("Kinderdagverblijven");
        ...
        if (jsonStr != null) {
            try {
                ...
                for (int i = 0; i < contacts.length(); i++) {
                    ...
                    String prijstype = c.getString("Prijstype");
                ...
                Collections.sort(listAttributes, new Comparator<Attributes>() {
                    @Override
    ...
    protected void onPostExecute(Void result) {
        ...
        mAdapter = new ExampleAdapter(listAttributes);
        ...
        mAdapter.setOnItemClickListener(new ExampleAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                Attributes attribuut = listAttributes.get(position);
                ...
                Intent intent = new Intent(KinderdagverblijvenActivity.this,DetailActivity.class);
